...
//     FileContextWorkspace = 'fileContextWorkspace',  // displays workspaces which should be included in context
//     FileContextFolder = 'fileContextFolder',        // content of the FileContext section (current context)
//     FileContextFile = 'fileContextFile'             // content of the FileContext section (current context)
// }
