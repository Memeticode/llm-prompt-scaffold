...
import { ProjectInfoItemType, ProjectInfoItemDefinition, } from './definitions';
...
export const PROJECT_INFO_ITEMS: ProjectInfoItemDefinition[] = [
        ...
        children: [
            {
                ...
                iconName: 'symbol-keyword' // Example icon
            },
            {
                label: 'Description',
    ...
    },
    {
        ...
        iconName: 'files'
        // , buttons: [
        //     { id: 'currentFileContextCollapseAll', icon: 'collapse-all', tooltip: 'Collapse All' },
        //     { id: 'currentFileContextExpandAll', icon: 'expand-all', tooltip: 'Expand All' }
        // ]
    }
];
